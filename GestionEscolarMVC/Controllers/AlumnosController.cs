...
namespace GestionEscolarMVC.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public AlumnosController(GestionEscolarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Alumnos != null ? 
                          ...
                          Problem("Entity set 'GestionEscolarContext.Alumnos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Idalumno,Nombre,Apellido,Correo")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idalumno,Nombre,Apellido,Correo")] Alumno alumno)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GestionEscolarContext.Alumnos'  is null.");
            }
            var alumno = await _context.Alumnos.FindAsync(id);
            if (alumno != null)
            {
